...
const aboutContent: AboutContent = {
  eyebrow: 'About me',
  title: 'A route into engineering shaped by teaching, creativity, and stubborn curiosity',
  intro:
  ...
  paragraphs: [
    ...
    'These days I am focused on Vue and Nuxt product engineering, Node.js backends, and practical AI-powered workflows. Away from the keyboard, I am a husband and father, and I still make time for drawing, books, travelling, the gym, cycling, and swimming.'
  ],
  milestones: [
